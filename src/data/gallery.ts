...
export const galleryItems: GalleryItem[] = [
  ...
  { src: '/images/slideshow/super-lab-moves-to-ncstate-2026.jpg', alt: 'The SuPER Lab is relocating from the University of Utah to North Carolina State University, Summer 2026', caption: 'SuPER Lab is moving to NC State — a Top-15 public engineering program (U.S. News) — this summer!', date: '2026-06', category: 'highlights', href: 'https://engr.ncsu.edu/about/facts-and-rankings/', fit: 'contain' },
  { src: '/images/slideshow/science-insertion-kinetics.png', alt: 'The Gao group work on lithium-ion intercalation kinetics is published in Science', caption: 'Our work on the insertion reaction kinetics is published in Science', date: '2025-10', category: 'highlights', href: 'https://doi.org/10.1126/science.adq2541', fit: 'contain' },
  { src: '/images/slideshow/nature-chem-li-deposition.png', alt: 'The Gao group perspective on lithium nucleation is published in Nature Chemistry', caption: 'Our views on Li deposition is published in Nature Chemistry', date: '2026-01', category: 'highlights', href: 'https://doi.org/10.1038/s41557-025-02023-3', fit: 'contain' },
