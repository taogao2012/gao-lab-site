...
kind: "thrust"
order: 3
keywords: ["Bayesian optimization", "physics-informed AI", "machine learning", "electrolyte design", "high-throughput screening"]
---
...
A two-stage deep-learning framework predicts Li-ion battery lifetime from limited early-cycle data, combining features extracted across multiple cycles to extend the reliability of early lifetime forecasts — reducing the time and cost of battery qualification. [Read the paper in Frontiers in Energy Research →](https://doi.org/10.3389/fenrg.2022.1059126)

### Two-level optimization for grid-scale battery energy storage

A two-level optimization framework for battery energy storage systems improves economics while minimizing long-term capacity fading, bridging operational dispatch decisions with degradation-aware scheduling. [Read the paper in Journal of Energy Storage →](https://doi.org/10.1016/j.est.2023.106943)

### Physics-guided ML for capacity-fading mechanism detection

A physics-guided ML framework classifies the dominant degradation mechanism using physics-informed features and regresses fading rates from early-cycle data — delivering both accurate prediction and mechanistic insight into why a cell is aging. [Read the paper in Batteries →](https://doi.org/10.3390/batteries10080283)

## Selected publications

- *Frontiers in Energy Research*, 2022, **10**, 1059126 — [Two-stage deep learning for early-stage Li-ion lifetime prediction](https://doi.org/10.3389/fenrg.2022.1059126).
- *Journal of Energy Storage*, 2023, **63**, 106943 — [Two-level optimization framework for battery energy storage](https://doi.org/10.1016/j.est.2023.106943).
- *Batteries*, 2024, **10**(8), 283 — [Physics-guided ML for capacity-fading mechanism detection](https://doi.org/10.3390/batteries10080283).
